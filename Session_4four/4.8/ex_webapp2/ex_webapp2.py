...
"""pic1 = Picture(link='http://img.bleacherreport.net/img/images/photos/003/357/607/hi-res-216c4eca516bb24626745dc1e9d0f5ab_crop_north.jpg?w=630&h=420&q=75',comment='Love this drawing! Go Golden State!')

pic2 = Picture(link='http://img.bleacherreport.net/img/images/photos/003/358/305/hi-res-3d12fb6698c432801d1b399ebe3d258f_crop_north.jpg?w=630&h=420&q=75',comment='LeBron going to take it all they way!')
...
class MainPage(webapp2.RequestHandler):
    def get(self):
        ...
        table = '<table><tr><th>Link</th><th>Comment</th></tr>'
        for picture in query:
            link = picture.link
