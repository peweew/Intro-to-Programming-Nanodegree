...
def user_input(index):
        user_input_answer=raw_input("What should go in blank __"+str(index)+"__: ")
        ...
        for a in answers:
                ...
                while True:
                        ...
                        if user_input_answer==a: #check the answer
                                game=game_replace(game,a,index_answer)#if user answer correct, replace __index__ by answer
                                break
                        continue
        win(level)
